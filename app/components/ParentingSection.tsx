        ...
        <div className="parenting-row">
          ...
          <div className="parenting-content">
            ...
            <p>
              ...
              when his daughter topped the All India UCEED exam in 2015.
              By applying principles of discipline, observation, and long-term
              thinking, he helps parents shift from control-driven methods to
              performance-focused nurturing.
            </p>

            <h4>
              ~ Dr. Bhooshan Shanbhag (PhD, CMT, CFTe)
            </h4>
